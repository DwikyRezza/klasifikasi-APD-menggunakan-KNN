 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "Notebook ini adalah versi implementasi klasifikasi menggunakan metode ekstraksi fitur HOG (Histogram of Oriented Gradients), reduksi dimensi PCA, dan model **Random Forest Classifier**."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "print(f\"Akurasi Random Forest pada data validasi internal (20%): {val_acc*100:.2f}%\")\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "plt.title(\"Confusion Matrix - HOG + PCA + Random Forest\")\n",
    "plt.show()\n",
    "\n",
