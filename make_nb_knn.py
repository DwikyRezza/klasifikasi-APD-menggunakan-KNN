 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "Ubah variabel `image_path` sesuai lokasi gambar yang ingin diuji."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "        print('Error: File tidak ditemukan:', image_path)\n",
    "        return\n",
    "\n",
    ...
    "    plt.imshow(img_rgb)\n",
    "    color = '#2e7d32' if prediction == 1 else '#c62828'\n",
    "    plt.title(\n",
    "        f'Prediksi: {predicted_class.upper()} ({confidence:.2f}% Confidence)\\n'\n",
    "        f'[helm={probabilities[0]*100:.1f}% | kacamata={probabilities[1]*100:.1f}%]',\n",
