 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Klasifikasi Kacamata dan Helm Menggunakan GLCM + HOG + Random Forest\n",
    "Notebook ini mengimplementasikan klasifikasi menggunakan kombinasi ekstraksi fitur **GLCM (tekstur)** dan **HOG (bentuk)**, kemudian diklasifikasikan menggunakan **Random Forest Classifier**."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "Menggunakan seluruh data training yang sudah distandarisasi."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "\n",
    "print('Model Random Forest dengan fitur GLCM + HOG berhasil dilatih!')\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "if helm_samples:\n",
    "    classify_and_visualize(helm_samples[0], rf_model, scaler_final)\n",
    "\n",
    "kaca_samples = glob.glob('dataset/test/kacamata/*.*')\n",
    "if kaca_samples:\n",
    "    classify_and_visualize(kaca_samples[0], rf_model, scaler_final)\n"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    ...
    "print(f'\\nAkurasi Model Random Forest + GLCM + HOG pada Dataset Test: {test_accuracy * 100:.2f}%')\n",
    "\n",
    ...
    "plt.title('Confusion Matrix - Random Forest + GLCM + HOG', fontsize=12, fontweight='bold')\n",
    "plt.show()\n"
   ]
  },
  {
...
with open("randomforest.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=1)
print("Notebook randomforest.ipynb berhasil dibuat!")
